...
| **Désactiver le fichier manifeste lors de l’export de tableaux complets** | Vous permet de désactiver le fichier manifeste inclus par défaut lors de l’exportation de tables complètes à partir d’Analysis Workspace. [En savoir plus](/help/analysis-workspace/export/export-cloud.md) |  | mercredi 20 mai 2025 |
