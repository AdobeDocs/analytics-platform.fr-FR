...
| Fonctionnalité et description | [Le déploiement commence](releases.md) | [Disponibilité générale](releases.md) |
| -----------|-----------|-----------|
| **Intégration de**<br> l’intégration entrante de Visibilité des marques [&#128279;](/help/integrations/bv.md#inbound-integration) vous permet d’ingérer des données Brand Visibility dans Customer Journey Analytics pour une analyse plus approfondie. | | 28 juillet 2026 |
