...
| **Recherches de périphériques Edge Network** | Activez la collecte automatique de données de type appareil via le réseau Edge Experience Platform. Ce service bénéficie au Customer Journey Analytics ainsi qu’à d’autres applications Experience Platform. [En savoir plus](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-device-lookup) | S.O. | 27 septembre 2023 |
...
| **Recherches géographiques du réseau Edge** | Vous pouvez utiliser les données de géolocalisation dans Customer Journey Analytics. Activez cette fonctionnalité dans les paramètres de flux de données. [En savoir plus](https://experienceleague.adobe.com/docs/experience-platform/datastreams/configure.html#geolocation-network-lookup) |  | 26 juillet 2023 |
