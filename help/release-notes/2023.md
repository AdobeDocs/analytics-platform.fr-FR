...
| **Recherches géographiques Experience Edge** | Une fois que les recherches géographiques Adobe Experience Edge seront activées pour votre train de données, vous pourrez créer des rapports à l’aide des données de géolocalisation dans Customer Journey Analytics. |  | 26 juillet 2023 |
