...
| ----------- | ---------- | ------- | ---- |
| **Nouvelles fonctionnalités de la vue [!UICONTROL Utilisation] dans Adobe Product Analytics** | Les fonctionnalités suivantes ont été ajoutées à la [vue Utilisation](/help/guided-analysis/types/trends.md) :<ul><li>**Tendances** : les tendances sont désormais prises en charge. Cliquez sur [!UICONTROL Incrustations] au-dessus du graphique pour les activer.</li><li>**Ventilation des requêtes** : vous pouvez désormais appliquer des ventilations à ce type de vue. Elles sont disponibles en tant qu’option dans le rail de requêtes.</li></ul> | S.O. | 25 octobre 2023 |
