...
| --- | --- |
| Mars | Contenu significativement mis à jour sur [estimation de la taille de connexion](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/estimate-connection-size.html?lang=en). |
| Février 2022 | [Adobe Analytics vers l’évolution des Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/aa-to-cja.html?lang=en) |
