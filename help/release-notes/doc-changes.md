...
| Canal mobile Content Analytics | Mises à jour de la [documentation Content Analytics](/help/content-analytics/content-analytics.md) pour décrire les fonctionnalités et la configuration du canal mobile Content Analytics. |
| **Avril 2026** | |
| Directives relatives aux champs dérivés | Ajout d’un article avec des [directives](/help/use-cases/data-views/derived-fields/guidelines.md) (bonnes pratiques, mécanismes de sécurisation et pièges courants) pour l’utilisation des champs dérivés. |
...
| **Mars 2026** | |
| Répartition d’un panneau | Restructuration de la documentation autour de la [zone de dépôt pour un panneau](/help/analysis-workspace/c-panels/panels.md#drop-zone) afin de prendre en charge la nouvelle fonctionnalité de [répartition](/help/analysis-workspace/c-panels/panels.md#break-down-a-panel). |
| Note technique sur les ID incorrects (BAVID) | Nouvelle note technique [sur les ID incorrects](/help/technotes/badids.md). La note technique explique la définition d’un ID incorrect, où sont utilisés les ID incorrects dans l’interface de Customer Journey Analytics et comment rechercher des ID incorrects dans les données de votre connexion. |
| Aperçu de la reconception des jeux de données dans Connexions | Mise à jour de la documentation pour une expérience d’aperçu des données améliorée lorsque vous [ajoutez](/help/connections/create-connection.md#add-datasets) ou [modifiez](/help/connections/create-connection.md#edit-a-dataset) des jeux de données dans des connexions basées sur une personne, y compris la documentation sur les [informations d’aperçu de groupement](/help/stitching/use-stitching-ui.md#datasets-preview) supplémentaires pour les jeux de données activés pour le groupement. |
| Miniatures et aperçus Content Analytics | Documentation sur les [miniatures](/help/content-analytics/report/report.md#thumbnails) et [aperçus](/help/content-analytics/report/report.md#previews) pour des visualisations supplémentaires dans Content Analytics. |
| **Février 2026** | |
| Remplacements d’en-têtes | Documentation sur la configuration supplémentaire des [remplacements d’en-tête](/help/content-analytics/config/guided.md#header-overrides) pour Content Analytics. |
| Mécanisme de sécurisation des mesures calculées | Mise à jour du [mécanisme de sécurisation pour le nombre maximal de mesures calculées d’une organisation](/help/technotes/guardrails.md#segments-and-calculated-metrics). Le maximum est maintenant de 50 000. |
| Content Analytics autonome | Ajout de la documentation relative à une [configuration autonome de Content Analytics](/help/content-analytics/config/standalone.md). |
| **Janvier 2026** | |
| Concevoir un schéma | Ajout d’informations et de contexte détaillés dans [Concevoir le schéma à utiliser avec Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-schema-architect.md). |
...
| --- | --- |
| **Décembre 2025** | |
| Implications des modifications apportées aux sandbox | Ajout des implications d’une suppression ou d’une réinitialisation de sandbox à l’article [Implications de la suppression et de la réinitialisation](/help/technotes/deletion.md). |
| **Novembre 2025** | |
...
| Connexions | Révision et mise à jour de la documentation de Customer Journey Connections en vue de la prochaine version de Customer Journey B2B Edition. |
...
| Collecte de médias : mises à jour du connecteur source Adobe pour le nouveau XDM de reporting des médias | Le connecteur source Analytics mappe automatiquement les données de médias en streaming dans Adobe Analytics aux mêmes champs utilisés par le SDK web. Auparavant, les données étaient mappées à la fois à l’ancien et au nouvel emplacement, mais seul le nouvel emplacement sera utilisé à l’avenir. [En savoir plus](https://experienceleague.adobe.com/fr/docs/analytics/implementation/aep-edge/xdm-var-mapping) |
| **Février 2025** |  |
| Collecte de médias : mises à jour du connecteur source Adobe pour le nouveau XDM de reporting des médias | Le connecteur source Analytics [mappe automatiquement les données de médias en streaming dans Adobe Analytics](https://experienceleague.adobe.com/fr/docs/analytics/implementation/aep-edge/xdm-var-mapping?lang=en) aux mêmes champs utilisés par le SDK web. Auparavant, les données étaient mappées à la fois à l’ancien et au nouvel emplacement, mais seul le nouvel emplacement sera utilisé à l’avenir. |
...
| Ajout d’une documentation sur les légendes intelligentes dans les cartes de performance mobiles | Les [légendes intelligentes](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-dashboards/manage-scorecard#captions) aident les personnes n’étant pas spécialisées dans l’analyse à mieux comprendre leurs données sans l’aide des analystes. |
| Nouvelle documentation pour les fonctionnalités d’Adobe Product Analytics | <ul><li>[Matrice des fonctionnalités](/help/guided-analysis/types/funnel.md)</li><li>Amélioration de la [rétention](/help/guided-analysis/types/retention.md)</li><li>[Informations améliorées dans l’entonnoir](/help/guided-analysis/types/funnel.md)</li><li>Comparer des événements dans une seule étape du funnel</li></ul> |
| **Mars 2024** | |
...
| Clarification selon laquelle les administrateurs et administratrices de produit ont toujours accès à l’export des tableaux complets. | Les modifications suivantes ont été apportées afin de préciser que les utilisateurs auxquels le rôle d’administrateur de produit est attribué peuvent, par défaut, exporter des tableaux complets depuis Analysis Workspace : <ul><li>Ajout d’une nouvelle puce aux [autorisations par défaut de l’administrateur ou administratrice de produit](/help/technotes/access-control.md#product-admin-default-permissions).</li><li>Ajout d’une note sous la [configuration minimale requise pour exporter des tableaux complets vers le cloud](/help/analysis-workspace/export/export-cloud.md#minimum-requirements).</li></ul> |
...
| **Octobre 2023** | |
| Utilisation d’un champ dérivé pour définir des objectifs/cibles | Ajout d’un article sur les [cas d’utilisation](/help/use-cases/data-views/derived-fields/goals-using-derived-fields.md) illustrant comment utiliser des champs dérivés pour définir des objectifs/cibles et créer des rapports à leur sujet. |
...
| Comparaison avec Adobe Analytics | Ajout d’une [page de vue d’ensemble](../getting-started/aa-vs-cja/overview.md) qui présente la comparaison et la compréhension des différences entre Customer Journey Analytics et Adobe Analytics. |
...
| Tri des composants dans le rail de gauche | Ajout d’informations sur le tri de la liste des composants dans le rail de gauche.Voir la section « Recherche, filtrage et tri de la liste des composants » dans [Vue d’ensemble des composants](/help/components/overview.md). |
...
| Calendriers et périodes de Workspace | Mise à jour du contenu pour décrire les périodes relatives, les mises à jour du calcul des formules et les modifications apportées à l’interface utilisateur du calendrier. Voir [À propos des périodes relatives du panneau](/help/components/date-ranges/overview.md#custom-date-ranges). |
...
| Septembre 2021 | Nouvelle section sur les [implications de la fusion de suites de rapports](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-overview/cja-faq.html#6.-considerations-when-merging-report-suites-in-cja) dans Customer Journey Analytics. |
| **Août 2021** | |
