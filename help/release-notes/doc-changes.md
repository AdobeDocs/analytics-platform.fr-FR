...
Les mises à jour suivantes ont été apportées à la documentation du Customer Journey Analytics depuis sa création.
...
| Mises à jour des mesures calculées | Les mises à jour suivantes ont été apportées à la documentation des mesures calculées afin de l’aligner sur la fonctionnalité actuelle du Customer Journey Analytics : <ul><li>Mise à jour de la liste des [mesures calculées par défaut](/help/components/calc-metrics/default-calcmetrics.md) disponible dans Customer Journey Analytics</li><li>mise à jour des captures d’écran et des procédures dans différents articles sur les mesures calculées </li></ul> |
| **Mai 2023** | |
...
| Mise à jour de l’optimisation | Mise à jour de l’article sur [Optimisation des performances du Customer Journey Analytics](/help/admin/optimizing-performance.md) |
...
| Champs dérivés | Ajout de la documentation pour [champs dérivés](../data-views/derived-fields/derived-fields.md) . |
| **Avril 2023** |  |
...
| **Mars 2023** | |
| Intégration des données de gestion des décisions | Ajout d’un contenu expliquant comment [Intégration des données de gestion des décisions Adobe Journey Optimizer dans Customer Journey Analytics](/help/integrations/ajo-od.md). |
...
| Mise à jour de la prise en charge des fonctionnalités | Mise à jour [Prise en charge des fonctionnalités de Customer Journey Analytics](/help/getting-started/aa-vs-cja/cja-aa.md) avec un tableau des fonctionnalités disponibles dans Customer Journey Analytics, mais pas disponibles ni prises en charge dans AA. |
...
| Mettre à jour la documentation Audiences | Après avoir créé une audience, Adobe crée un Experience Platform [segment de diffusion en continu pour chaque nouvelle audience de Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-components/audiences/publish.html?lang=fr#after-audience-created). |
...
| Cartes de performance mobiles | Nouvelle section de documentation pour décrire comment afficher et masquer les périodes de comparaison. Voir [Afficher les plages de dates de comparaison](/help/mobile-app/create-scorecard.md#show-comparison-dates) en Customer Journey Analytics. |
| **Janvier 2023** | |
...
| Guides de démarrage rapide de l’ingestion de données | Nouvelle section de documentation sur la procédure à suivre [ingestion et utilisation des données](/help/data-ingestion/data-ingestion.md) en Customer Journey Analytics. |
...
| --- | --- |
| **Décembre 2022** |  |
| 16 décembre 2022 | Nouvelle rubrique sur [mesure et gestion de l’utilisation des données Customer Journey Analytics](/help/admin/estimate-usage.md). |
| **Octobre 2022** | |
...
| Octobre 2022 | Nouvelle rubrique sur [Journal d’audit du Customer Journey Analytics](/help/privacy/audit-log.md). |
...
| **Septembre 2022** | |
| Septembre 2022 | Nouveau cas d’utilisation sur [Migration de données de Google Analytics vers Customer Journey Analytics](/help/use-cases/ga/overview.md). |
...
| Août 2022 | Article considérablement mis à jour sur [Contrôle d’accès Customer Journey Analytics](/help/admin/cja-access-control.md). |
| Août 2022 | Nouvel article sur [Prise en charge des Customer Journey Analytics pour les libellés et les stratégies de gouvernance des données](/help/data-views/data-governance.md). |
...
| Juin 2022 | Nouvel article sur [comparaison du traitement des données entre Adobe Analytics et les fonctionnalités de création de rapports Customer Journey Analytics](/help/getting-started/aa-vs-cja/data-processing-comparisons.md). |
...
| Juin 2022 | Nouvel article sur [Analytics Labs en Customer Journey Analytics](/help/labs/labs.md). |
...
| **Mai 2022** | |
| Mai 2022 | Article considérablement mis à jour sur [création de connexions](/help/connections/create-connection.md) en Customer Journey Analytics. |
| Mai 2022 | Nouvel article sur la procédure à suivre [gestion des blocs de données dans Customer Journey Analytics Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/manage-reportbuilder.html?lang=fr). |
| Mai 2022 | Nouvel article sur [ingestion d’audiences Adobe Experience Platform dans Customer Journey Analytics](/help/use-cases/data-ingestion/ingest-aep-segments.md). |
| **Avril 2022** | |
...
| Avril 2022 | Nouveau [Guide de l’utilisateur du Customer Journey Analytics pour les utilisateurs d’Adobe Analytics](/help/getting-started/aa-to-cja-user.md). |
| **Mars 2022** | |
| Mars 2022 | Nouveau [Documentation de l’API Annotations Customer Journey Analytics](https://developer.adobe.com/cja-apis/docs/endpoints/annotations/). |
...
| **Février 2022** | |
| Février 2022 | Un nouveau guide destiné aux administrateurs qui passent d’Adobe Analytics à Customer Journey Analytics : [Adobe Analytics vers l’évolution des Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/compare-aa-cja/aa-to-cja.html?lang=fr) |
| **Janvier 2022** | |
| Janvier 2022 | Nouveau cas pratique pour [Utilisation de dimensions et de mesures de liaison dans Customer Journey Analytics](/help/use-cases/data-views/binding-dimensions-metrics.md) |
...
| Janvier 2022 | Nouvel article sur [comparaison des données Adobe Analytics aux données Analytics dans Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics-platform/using/troubleshooting/compare.html?lang=fr) |
...
| --- | --- |
| **Novembre 2021** | |
| Novembre 2021 | Mise à jour de la documentation pour [[!UICONTROL Enregistrements ignorés]](/help/connections/manage-connections.md) sur la page Détails de la connexion. |
| **Octobre 2021** | |
| Octobre 2021 | Documentation pour [Report Builder](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-reportbuilder/report-buider-overview.html?lang=fr#) en Customer Journey Analytics. |
...
| Septembre 2021 | Nouvelle section sur la [implications de la fusion des suites de rapports](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-faq.html?lang=fr#6-considerations-when-merging-report-suites-in-cja) en Customer Journey Analytics. |
| **Août 2021** | |
| Août 2021 | Nouvelle section sur l’amélioration de [Connexions](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/manage-connections.html?lang=fr) expérience en Customer Journey Analytics. |
...
| Avril 2021 | Nouvelle rubrique sur [dimensions à cardinalité élevée en Customer Journey Analytics](/help/components/dimensions/high-cardinality.md). |
| **Mars 2021** | |
...
| Février 2021 | Publié le nouveau [API Customer Journey Analytics](https://www.adobe.io/cja-apis/docs/) documentation. |
| **Janvier 2021** | |
...
| Décembre 2019 | Première version de la documentation du Customer Journey Analytics |
