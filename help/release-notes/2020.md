---
title: Afficher les notes de mise à jour de 2020 de Customer Journey Analytics
description: Notes de mise à jour de 2020 de Customer Journey Analytics
...
# Notes de mise à jour de 2020 de Customer Journey Analytics
...
| Assemblage basé sur les champs de Customer Journey Analytics | 30 octobre 2020 | L’assemblage basé sur les champs de Customer Journey Analytics permet aux clientes et clients de recréer un jeu de données d’événement Adobe Analytics (ou autre) dans le lac de données Adobe Experience Platform d’un espace de noms d’ID à un autre. En règle générale, cela signifie recréer le jeu de données d’événement d’un identifiant basé sur un cookie vers un identifiant basé sur une personne. De cette façon, le jeu de données recréé peut être combiné avec d’autres données personnelles dans une connexion Customer Journey Analytics, ce qui permet une analyse entre appareils ou cross-canal dans Analysis Workspace. |

## Septembre 2020

| Fonctionnalité | [Disponibilité générale](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=fr) - Date cible | Description |
| ----------- | ---------- | ----- |
| Modifications des autorisations de Customer Journey Analytics | 9 septembre 2020 | Customer Journey Analytics ne traitera plus tous les utilisateurs et utilisatrices comme des administrateurs et administratrices. Seuls les utilisateurs qui ont été désignés comme administrateurs de produits dans la [Adobe Admin Console](https://experienceleague.adobe.com/docs/core-services/interface/manage-users-and-products/admin-getting-started.html?lang=fr) pourront effectuer les actions suivantes :<ul><li>Créer/mettre à jour/supprimer des [!UICONTROL connexions] ou des [!UICONTROL vues de données]</li><li>Mettre à jour/supprimer des projets, des segments ou des mesures calculées créés par d’autres utilisateurs</li><li>Partager un projet d’espace de travail avec tous les utilisateurs</li></ul>[En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-overview/cja-overview.html?lang=fr#admin-access-permissions) |
| Prise en charge de la [!UICONTROL détection des anomalies] | 10 septembre 2020 | [!UICONTROL Détection des anomalies] vous permet d’identifier les fluctuations statistiques importantes et celles qui ne le sont pas. Cette fonctionnalité est désormais prise en charge dans . |
...
| Fonctionnalité | [Disponibilité générale](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=fr) - Date cible | Description |
| ----------- | ---------- | ----- |
| Workspace : améliorations de la visualisation par ligne | 17 septembre 2020 | <ul><li>Vous pouvez afficher ou masquer l’axe des x et l’axe des y de n’importe quelle visualisation par ligne. Cela peut s’avérer particulièrement utile lorsque les visualisations par ligne sont plus compactes.</li><li>Vous pouvez superposer un libellé de valeur minimale et maximale sur n’importe quelle visualisation par ligne pour mettre rapidement en évidence les hausses et les baisses d’une mesure.</li><li>Vous pouvez superposer différentes lignes de tendance de régression sur n’importe quelle visualisation par ligne afin de visualiser plus facilement la tendance dans les données. Les options disponibles sont Linéaire, Logarithmique, Exponentielle, Puissance et Quadratique.</li></ul>[En savoir plus](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/visualizations/line.html?lang=fr) |

## Juin 2020

| Fonctionnalité | [Disponibilité générale](https://experienceleague.adobe.com/docs/analytics/landing/an-releases.html?lang=fr) - Date cible | Description |
| -----------| ---------- |-----|
| Prise en charge des tableaux d’objets | 18 juin 2020 | Les clientes et clients Customer Journey Analytics peuvent désormais créer des rapports sur les dimensions et les mesures qui apparaissent dans les tableaux d’objets dans leurs schémas de jeux de données d’Adobe Experience Platform. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-usecases/complex-data/object-arrays.html?lang=fr) |
| [!UICONTROL Attribution algorithmique] | 18 juin 2020 | Le modèle d’[!UICONTROL attribution algorithmique] d’[!UICONTROL Analysis Workspace] utilise des techniques statistiques pour déterminer de manière dynamique la distribution optimale du crédit pour la mesure sélectionnée. Disponible pour les clientes et clients Adobe Analytics Ultimate. [En savoir plus](/help/data-views/component-settings/attribution.md) |
| Intervalles de recherche en amont personnalisés | 18 juin 2020 | Vous pouvez désormais configurer n’importe quel modèle d’attribution pour inclure des points de contact jusqu’à 90 jours avant la période de création de rapports. Cela permet généralement d’accroître la précision de l’attribution pour les événements survenant au début de la période de création des rapports, en tenant compte des interactions qui se sont produites au cours du ou des mois précédents. [En savoir plus](/help/data-views/component-settings/attribution.md) |
| Prise en charge de la [!UICONTROL détection des anomalies] | 18 juin 2020 | La [!UICONTROL Détection des anomalies] offre une méthode statistique permettant de déterminer comment une mesure donnée a changé par rapport aux données antérieures. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-workspace/virtual-analyst/anomaly-detection/anomaly-detection.html?lang=fr) |
...
| Fonctionnalité | Description |
| -----------| ---------- |
| Analysis Workspace - Modèle de [!UICONTROL Tutoriel de formation] | Ce nouveau modèle standard vous guide dans la terminologie et les étapes courantes de création de votre première analyse dans l’espace de travail. Il est disponible sous forme de modèle standard dans le modal [!UICONTROL Nouveau projet] et remplace l’exemple de projet qui existe aujourd’hui pour les nouveaux utilisateurs qui n’ont pas d’autres projets dans leur liste. |
...
| Débogueur d’espace de travail | Le débogueur d’espace de travail a été ajouté au menu [!UICONTROL Aide], ce qui vous permet de l’activer plus facilement pour le débogage des requêtes de l’espace de travail. [En savoir plus](https://experienceleague.adobe.com/fr/docs/analytics-learn/tutorials/apis/using-analysis-workspace-to-build-api-2-requests) |
