...
| **Rapports de session récurrente** | Déterminez si une session particulière a été la session récurrente d’un utilisateur. [En savoir plus](/help/data-views/data-views-usecases.md) | 14 septembre 2022 |
