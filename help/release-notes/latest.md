...
| -----------|-----------|-----------|
| **Intégration de**<br> l’intégration entrante de Visibilité des marques [](/help/integrations/bv.md#inbound-integration) vous permet d’ingérer des données Brand Visibility dans Customer Journey Analytics pour une analyse plus approfondie. | 28 juillet 2026 | 28 juillet 2026 |
