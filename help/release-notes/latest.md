...
| **Désactiver le fichier manifeste lors de l&#39;export de tables complètes** | Vous permet de désactiver le fichier manifeste inclus par défaut lors de l’exportation de tables complètes à partir d’Analysis Workspace. |  | Fin mai 2025 |
