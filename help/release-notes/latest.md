...
| **Connecteur source Analytics : recherche de suites de rapports dans Experience Platform** | Si vous disposez d’un grand nombre de suites de rapports, vous pouvez désormais [rechercher la suite de rapports](/help/data-ingestion/analytics.md#set-up-an-adobe-analytics-source-connector) à laquelle vous souhaitez vous connecter dans le workflow de flux de données du connecteur Source Analytics . | | 30 octobre 2025 |
