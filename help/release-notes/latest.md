...
**Dernière mise à jour** :jeudi 30 avril 2025
...
| ----------- | ---------- | ------- | ---- |
| **Dimension Profondeur de l’événement** | Une nouvelle dimension Profondeur de l’événement est ajoutée à la liste des [composants standard requis](/help/data-views/component-reference.md#required-standard-components) pour une vue de données. |  | vendredi 8 mai 2025 |
