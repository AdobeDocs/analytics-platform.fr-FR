...
| **Mise en récit des données : générer des présentations de diapositives à partir de rapports Workspace** | Vous pouvez désormais générer automatiquement une présentation de diapositives (au format .pptx) à partir d’un rapport Analysis Workspace. Workspace détecte les informations clés de votre rapport et les convertit en diapositives prêtes à être présentées aux parties prenantes.<p>Cette fonctionnalité réduit le temps et les efforts nécessaires pour faire ressortir les conclusions, élaborer des récits à l’intention de la direction et communiquer l’incidence sur l’entreprise.</p><p>Pour plus d’informations, voir [storytelling de données : générer des présentations de diapositives à partir de rapports Workspace](/help/analysis-workspace/curate-share/generate-slides.md).</p> | 22 octobre 2025 | Janvier 2026 |
