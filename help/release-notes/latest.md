...
| **Création de rapports en temps réel** | Les rapports en temps réel dans Customer Journey Analytics affichent et mettent à jour en temps réel les données et les visualisations au sein d’un ou de plusieurs panneaux dans Analysis Workspace.<br/><br/>(Lien vers la documentation à suivre.) | | 17 septembre 2025 (version initialement prévue pour le 15 août 2025) |
