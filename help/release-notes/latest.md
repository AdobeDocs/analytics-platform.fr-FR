...
| **Panneau d’expérience pour CJA (effet élévateur générique et degré de confiance)** | Ce nouveau panneau Workspace permet aux utilisateurs de CJA d’évaluer l’effet élévateur et le degré de confiance de toute expérience A/B à partir de n’importe quelle source (en ligne, hors ligne, à partir de solutions d’Adobe, de Adobe Journey Optimizer et même de données BYO). Informations supplémentaires à suivre. | 17 août 2022 |
