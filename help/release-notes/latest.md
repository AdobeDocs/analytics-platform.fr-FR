...
| **Utilisation de votre vue de données de Customer Journey Analytics avec Adobe Journey Optimizer** | Une nouvelle option de configuration dans Customer Journey Analytics vous permet de désigner une vue de données de Customer Journey Analytics à utiliser avec Adobe Journey Optimizer, sans avoir à effectuer de configuration manuelle. <!-- add this in: <p>For information about how to enable this configuration option, see the [Compatibility](/help/data-views/create-dataview.md#compatibility) section in [Create or edit a data view](/help/data-views/create-dataview.md).</p> --><p>Auparavant, vous deviez configurer manuellement une connexion et des vues de données lors de l’affichage de données Adobe Journey Optimizer dans Customer Journey Analytics.</p><p>(Lien vers la documentation à suivre)</p> |  | jeudi 19 juin 2024 |
