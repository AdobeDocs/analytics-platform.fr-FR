...
| **Data Insights Agent sur Agent Orchestrator** <br/> En plus d’être disponible dans le rail de droite dans Customer Journey Analytics, Data Insights Agent est désormais disponible dans le cadre d’Agent Orchestrator. Cela signifie que vous pouvez désormais obtenir des informations qui reposent sur les données et les fonctionnalités de Customer Journey Analytics lorsque vous travaillez dans d’autres applications Experience Platform, telles que dans Journey Optimizer.<p>Dans Customer Journey Analytics, Data Insights Agent comprend les améliorations suivantes :</p><ul><li>Une expérience utilisateur plus cohérente avec Agent Orchestrator</li><li>Paragraphes du résumé explicatif</li><li>Réponses aux questions « pourquoi » grâce à l’analyse des causes profondes</li><li>Tableaux en ligne</li><li>Et bien plus encore !&lt;/l></ul><p>(Lien vers la documentation à suivre.)</p> | | Fin mai 2026 |
