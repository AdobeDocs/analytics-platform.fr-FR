...
| **Carte de la connexion** | Une nouvelle [interface de mappage des connexions](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-connections/create-connection#connection-map) est disponible pour afficher visuellement votre configuration de connexion. |  | 18 juin 2025 |
