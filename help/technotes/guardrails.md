...
Consultez également la section Mécanismes de sécurisation d’Experience Platform [Exportation de jeu de données](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/guardrails#dataset-exports)
