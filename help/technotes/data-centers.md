...
Consultez [Collecte de données régionale](https://experienceleague.adobe.com/fr/docs/core-services/interface/data-collection/rdc) dans la documentation Adobe CX Enterprise pour plus d’informations.
...
1. Le code de région du centre de données qui vous a été attribué s’affiche dans la partie supérieure droite d’Experience Platform.
   ...
   ![Centre de données sur la page d’accueil d’Experience Platform](assets/experience-platform-data-center.png)
