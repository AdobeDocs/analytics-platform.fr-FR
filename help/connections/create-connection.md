...
>abstract="Une modification de l’identifiant de compte global supprime toutes les données existantes dans la connexion et réingère toutes les données du jeu de données en fonction du nouvel identifiant de compte global. Cette action peut avoir des répercussions sur les coûts. <br/><br/>Lorsque vous sélectionnez **[!UICONTROL Continuer]**, un délai dans la création de rapports est possible jusqu’à ce que le processus soit terminé."
...
>abstract="Une modification de l’identifiant du groupe d’achats supprime toutes les données existantes dans la connexion et réingère toutes les données du jeu de données en fonction du nouvel identifiant du groupe d’achats. Cette action peut avoir des répercussions sur les coûts. <br/><br/>Lorsque vous sélectionnez **[!UICONTROL Continuer]**, un délai dans la création de rapports est possible jusqu’à ce que le processus soit terminé."
...
| Paramètre | Description |
| --- | --- |
| **[!UICONTROL ID de compte]** | Sélectionnez un identifiant de compte global (l’identifiant unique d’un compte) parmi les identités disponibles définies dans le schéma du jeu de données dans Experience Platform. Applicable lorsque vous avez ajouté le compte global en tant que conteneur à votre connexion. <p>Si un enregistrement ne contient pas de valeur pour l’identité que vous avez sélectionnée comme ID de compte pour le jeu de données d’événement, l’enregistrement est ignoré. |
