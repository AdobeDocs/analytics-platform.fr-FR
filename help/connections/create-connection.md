...
1. Dans ❸ Aperçu des jeux de données **[!UICONTROL vous voyez un aperçu de chaque jeu de données basé sur un simple jeu de données provenant de données récemment ingérées.]**
