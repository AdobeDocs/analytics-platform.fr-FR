...
>abstract="L’utilisation de Customer Journey Analytics peut entraîner des modifications supplémentaires en fonction des volumes de données d’intégration. Voir [détails sur la facturation et l’utilisation de Customer Journey Analytics](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-connections/manage-connections#connections-usage)"
