...
>abstract="Une modification de l’ID persistant supprime toutes les données existantes dans la connexion et réingère toutes les données du jeu de données en fonction du nouvel ID persistant. Cette action peut avoir des répercussions sur les coûts. <br/><br/>Lorsque vous sélectionnez **[!UICONTROL Continuer]**, un délai dans la création de rapports est possible jusqu’à ce que le processus soit terminé."
...
>abstract="Sélectionnez un champ pour adhérer à l’un des jeux de données d’événement. Si cette liste est vide, vous n’avez probablement pas ajouté ni configuré de jeu de données d’événement."
...
>title="Passer au graphique d’identités"
>abstract="Assurez-vous d’avoir terminé la configuration du graphique d&#39;identité avant de l’utiliser pour le groupement."
