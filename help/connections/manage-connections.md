...
>abstract="Quantité totale de données stockées sur le disque horodatées pour le mois en cours (en To), avec un pourcentage de changement par rapport au mois précédent."
