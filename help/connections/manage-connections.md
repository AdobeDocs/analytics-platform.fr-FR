...
>abstract="Quantité moyenne de stockage consommée par chaque ligne de données ingérée et stockée dans Customer Journey Analytics (en Ko) pour le mois en cours, avec un pourcentage de modification par rapport au mois précédent."
