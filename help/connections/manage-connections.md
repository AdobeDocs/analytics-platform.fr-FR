...
| **[!UICONTROL Type de connexion]** | Filtrez les connexions [!BADGE ]{type=Informative url="https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-overview/cja-b2b/cja-b2b-edition" newtab=true tooltip="Customer Journey Analytics B2B Edition"} basées sur **[!UICONTROL personne]** ou sur **[!UICONTROL compte]**. |
...
1. Recherchez la connexion Journey Optimizer à utiliser avec Customer Journey Analytics.
   ...
   1. Dans la section **[!UICONTROL Utiliser dans CJA]**, sélectionnez **[!UICONTROL Désactivé]**.
      ...
      ![Filtrer pour afficher les connexions non activées pour AJO](assets/remove-ajo-connection.png)

1. Sélectionnez le nom de la connexion Journey Optimizer.

1. Sélectionnez ![UsersShare](/help/assets/icons/UseInCJA.svg) **[!UICONTROL Utiliser dans CJA]**.

   ![Bouton Utiliser dans CJA](assets/connection-use-in-cja.png)

   La boîte de dialogue **[!UICONTROL Utiliser cette connexion dans Customer Journey Analytics]** s’affiche.
...
Vous pouvez supprimer une connexion Journey Optimizer de Customer Journey Analytics à tout moment. Toutefois, la suppression de la connexion de Customer Journey Analytics après son utilisation entraîne les conséquences suivantes :
...
* Vous ne pouvez plus effectuer une analyse approfondie des données Journey Optimizer dans Customer Journey Analytics.

  Cela signifie que le bouton **[!UICONTROL Analyser dans CJA]** de Journey Optimizer est désactivé.

>[!IMPORTANT]
>
>La facturation de cette connexion dans Customer Journey Analytics inclut le mois complet pendant lequel la connexion est supprimée.


Pour supprimer cette connexion de Customer Journey Analytics :
...
1. Pour afficher la connexion, sélectionnez le nom de la connexion Journey Optimizer à supprimer de Customer Journey Analytics.
...
Pour accéder aux détails d’une connexion, sélectionnez un nom de connexion avec un lien hypertexte dans le tableau des connexions.
...
|---|---|
| **Lignes d’historique à déclarer** | Nombre de lignes pour la période au-delà de 13 mois. |
| **Lignes principales à inclure dans un rapport** | Nombre de lignes au cours des 13 derniers mois. |
| **Volume de données principal** | Quantité totale de données stockées sur le disque. |
...
>[!MORELIKETHIS]
>
>Tutoriel [Afficher, résoudre les problèmes et modifier les paramètres de connexion](https://experienceleague.adobe.com/fr/docs/customer-journey-analytics-learn/tutorials/connections/connections-details-experience-in-cja).Gérer l’utilisation de Customer Journey Analytics](/help/technotes/estimate-usage.md)
>
