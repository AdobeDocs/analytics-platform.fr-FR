...
| [!UICONTROL Sandbox] | Affiche l’ [environnement de test Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/sandbox/home.html?lang=fr) à partir duquel cette connexion dessine ses jeux de données. Ce sandbox a été sélectionné lorsque vous avez créé la connexion pour la première fois. Il ne peut pas être modifié. |
| [!UICONTROL Propriétaire] | Personne qui a créé la connexion. |
| [!UICONTROL Importer de nouvelles données] | Affiche l’état de l’importation de nouvelles données pour les jeux de données : <p>![État vert](assets/status-green.svg))    **[!UICONTROL _x _On]**pour les jeux de données configurés pour importer de nouvelles données et<p>![État gris](assets/status-gray.svg)   **[!UICONTROL _x Off_]** pour les jeux de données non configurés pour importer de nouvelles données. |
...
| [!UICONTROL Tableau de jeux de données] | Affiche les jeux de données qui font partie de la connexion. |
...
| [!UICONTROL Type de jeu de données] | Type de jeu de données pour ce jeu de données. Le type peut être [!UICONTROL Event], [!UICONTROL Lookup] ou [!UICONTROL Profile]. [En savoir plus](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=fr#configure-dataset) |
| Schéma | Schéma Experience Platform sur lequel le jeu de données est basé. |
| [!UICONTROL Importer de nouvelles données] | Affiche l’état de l’importation de nouvelles données pour le jeu de données : <p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _Sur]**si le jeu de données est configuré pour importer de nouvelles données, et<p>![État gris](assets/status-gray.svg)   **[!UICONTROL _x Off_]** si le jeu de données est configuré pour ne pas importer de nouvelle importation de données. |
| [!UICONTROL Transformer les données] | Affiche l’état de transformation des jeux de données de recherche B2B applicables. Voir [Transformer des jeux de données pour les recherches B2B](transform-datasets-b2b-lookups.md) pour plus d’informations.<p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _On]**pour les jeux de données applicables activés pour la transformation, <p>![État gris](assets/status-gray.svg)   **[!UICONTROL _x Off_]** pour les jeux de données applicables non activés pour la transformation et<p>**[!UICONTROL N/A]** pour tous les autres jeux de données, non applicable à la transformation. |
...
| [!UICONTROL Importer de nouvelles données] | Affiche l’état de l’importation de nouvelles données pour le jeu de données : <p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _Sur]**si le jeu de données est configuré pour importer de nouvelles données, et<p>![État gris](assets/status-gray.svg)   **[!UICONTROL _x Off_]** si le jeu de données est configuré pour ne pas importer de nouvelles données. |
| [!UICONTROL Renvoyer les données] | Affiche l’état des données de renvoi pour le jeu de données.<p>![État rouge](assets/status-red.svg)   **[!UICONTROL _x _backfills failed]**pour le nombre de renvoi ayant échoué,<p>![État rouge](assets/status-orange.svg)   **[!UICONTROL _x _traitement des renvois]**pour le nombre de traitement des renvois,<p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _renvois terminés]**pour le nombre de renvois terminés, et<p>![État gris](assets/status-gray.svg)   **[!UICONTROL _Désactivé_]** si aucun renvoi n’est configuré. |
...
| [!UICONTROL Importer de nouvelles données] | Affiche l’état de l’importation de nouvelles données pour les jeux de données : <p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _Sur]**pour connaître le nombre de jeux de données configurés pour importer de nouvelles données, et<p>![État gris](assets/status-gray.svg)   **[!UICONTROL _x Off_]** pour connaître le nombre de jeux de données désactivés lors de l’importation. |
...
| Transformer les données | Affiche l’état de transformation des jeux de données de recherche B2B applicables. Voir [Transformer des jeux de données pour les recherches B2B](transform-datasets-b2b-lookups.md) pour plus d’informations.<p>![État vert](assets/status-green.svg)   **[!UICONTROL _x _Sur]**pour le nombre de jeux de données activés pour la transformation. |
...
>[!MORELIKETHIS]
>
>[Tutoriel sur l’affichage, le dépannage et la modification des paramètres de connexion](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections/connections-details-experience-in-cja.html).
