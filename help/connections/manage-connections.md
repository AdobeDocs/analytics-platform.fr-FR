...
>abstract="Quantité moyenne de stockage consommée par chaque ligne de données ingérées et stockées dans Customer Journey Analytics (en Ko) pour le mois en cours, avec un pourcentage de changement par rapport au mois précédent."


>[!CONTEXTUALHELP]
>id="connections_coredatavolume"
>title="Volume des données principales"
>abstract="Quantité totale de données stockées sur le disque horodatées pour le mois en cours (en Go ou To), avec un pourcentage de changement par rapport au mois précédent."
