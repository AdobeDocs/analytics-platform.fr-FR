...
| [!UICONTROL Enregistrements ajoutés] | Indique combien de lignes ont été ajoutées au cours de la période sélectionnée. |
| [!UICONTROL Enregistrements supprimés] | Indique le nombre dʼenregistrements supprimés au cours de la période sélectionnée. |
