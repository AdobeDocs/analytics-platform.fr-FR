...
>[!NOTE]
>
>Pour connaître la différence terminologique (segments, filtres, etc.) entre l’analyse guidée et Analysis Workspace, consultez la [FAQ](faq.md) .
...
| ![Visualisation de menu](assets/menu-visualization.png) | **Menu**<br/> Disponible dans une visualisation d’analyse guidée dans Analysis Workspace. | Commandes disponibles dans une visualisation d’analyse guidée dans Analysis Workspace.<ul><li>![GraphScatter](/help/assets/icons/GraphScatter.svg) **[!UICONTROL Chart]** : pour afficher uniquement le graphique de l’analyse.</li><li>![Table](/help/assets/icons/Table.svg) **[!UICONTROL Table]** : pour afficher uniquement la table de l’analyse.</li><li>![TableAndChart](/help/assets/icons/TableAndChart.svg) **[!UICONTROL All]** : pour afficher le graphique et le tableau de l’analyse.</li><li>![Modifier](/help/assets/icons/Edit.svg) **[!UICONTROL Modifier]** : pour modifier la configuration de l’analyse</li><li>![Calendrier](/help/assets/icons/Calendar.svg) **[!UICONTROL *Plage de dates *]**: pour configurer la plage de données pour l’analyse.</li></ul> |
