...
description: Suivez les modifications du taux de conversion au fil du temps.
...
* **Suivi des efforts d’optimisation** : après avoir identifié les goulets d’étranglement clés que vous souhaitez améliorer à l’aide de l’analyse [entonnoir](funnel.md), vous pouvez utiliser cette analyse pour suivre l’impact de ces optimisations sur le taux de conversion au fil du temps.
...
* **[!UICONTROL Vue]** : basculer entre cette analyse et [Entonnoir](funnel.md).
...
* **[!UICONTROL Type de graphique]** : le type de visualisation que vous souhaitez utiliser. Les options incluent [!UICONTROL Ligne].
...
>[!NOTE]
>
>La colonne **Moyenne** du tableau d’analyse des tendances de conversion diffère de la colonne **Total** du tableau [Analyse en entonnoir](funnel.md). Le premier est une moyenne des colonnes de l’intervalle (par exemple, la moyenne des taux de conversion quotidiens), tandis que le second est un calcul agrégé sur l’ensemble de la période.
