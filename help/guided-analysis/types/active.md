...
# Vue [!UICONTROL Active]

La vue **[!UICONTROL Active]** fournit des informations sur la croissance et l’acquisition des utilisateurs sur une période spécifique. L’axe horizontal est un intervalle de temps, tandis que l’axe vertical est une mesure des utilisateurs. Les utilisateurs sont répartis en quatre catégories :
