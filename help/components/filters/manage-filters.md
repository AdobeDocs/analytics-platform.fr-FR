...
Le Gestionnaire de filtres affiche tous les que vous possédez et qui ont été partagés avec vous. Les utilisateurs de niveau administrateur peuvent voir tous les  de l’organisation. Cet aperçu présente l’interface utilisateur et les fonctionnalités du Gestionnaire de filtres.

Accédez au Gestionnaire de filtres en sélectionnant **[!UICONTROL Customer Journey Analysis]** > **[!UICONTROL Components]** > **[!UICONTROL Filters]** dans la barre de navigation supérieure.
...
| 4 | Favoris | Lorsque vous cliquez sur l’étoile en regard d’un filtre, l’étoile devient jaune et le filtre est marqué comme favori. |
...
| 12 | Icône Partagé | Indique que ce filtre est partagé par vous ou avec vous. |
| 13 | Icône Approuvé | Indique que ce filtre a été approuvé par un administrateur. |
| 14 | Autres  | Permet d’afficher les  par balises, suites de rapports, propriétaires et autres (Tout afficher, Le mien, Partagé avec moi, Approuvé, Favoris). |
...
1. Dans le Gestionnaire de filtres, cochez la case en regard du filtre à baliser. La barre d’outils de la gestion des filtres s’affiche.

1. Cliquez sur **[!UICONTROL Tag]** puis sur
...
Dans le Gestionnaire de filtres, vous pouvez configurer un flux de travail qui inclut l’approbation du filtre pour différents niveaux d’application, pour des services ou des groupes spécifiques et en conformité avec les stratégies de .

Voici comment marquer un filtre comme approuvé :

1. Dans le Gestionnaire de filtres, cochez la case à gauche du titre du filtre.

1. Cliquez sur **[!UICONTROL Approve]** dans la barre de  de la gestion des filtres.

1. Envisagez de partager le segment approuvé avec votre entreprise.

1. Cliquez sur **[!UICONTROL OK]**.

   Remarquez l’icône d’approbation en regard du filtre dans le  :
...
Selon vos autorisations, vous pouvez partager des  avec l’ensemble de votre organisation, des groupes ou des utilisateurs individuels.
...
1. Dans le Gestionnaire de filtres, cochez la case en regard du filtre à partager.

1. Dans la barre d’outils de la gestion des filtres, cliquez sur **[!UICONTROL Share]**.

1. Si vous êtes administrateur, vous pouvez sélectionner Tous ou effectuer une sélection dans les Groupes et Utilisateurs de votre entreprise. En tant que non administrateur, vous ne pouvez consulter que les utilisateurs individuels. Utilisez le champ Rechercher pour rechercher des groupes ou des utilisateurs. Cliquez sur **[!UICONTROL Share]**. The Shared icon appears next to the filter: ![](assets/share_icon.png)

1. Vous pouvez filtrer selon les  de partagées avec vous en accédant à  > Autres  > Partagé avec moi.

### Marquer les  comme favoris

Le marquage des segments en tant que favoris est une autre manière de les organiser pour en faciliter l’utilisation.

1. Dans le Gestionnaire de filtres, cochez l’étoile en regard de tout filtre que vous souhaitez marquer comme favori. L&#39;étoile devient jaune lorsque vous la sélectionnez.
