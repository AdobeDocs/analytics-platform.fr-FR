...
| **[!UICONTROL Titre et description]** | Pour modifier le filtre, sélectionnez le lien de titre qui ouvre le [Créateur de filtres](filter-builder.md). Un filtre partagé est indiqué avec ![Share](/help/assets/icons/ShareAlt.svg). |
