...
1. Sur le [!UICONTROL **Exportations**] , sélectionnez l&#39;export à modifier.
...
1. Sur le [!UICONTROL **Exportations**] sélectionnez l&#39;export à dupliquer.
...
1. Sur le [!UICONTROL **Exportations**] sélectionnez l&#39;export à exécuter.
...
1. Sur le [!UICONTROL **Exportations**] sélectionnez une ou plusieurs exportations à baliser.

1. Sélectionner [!UICONTROL **Balise**].

1. Dans la boîte de dialogue d’exportation de balises, saisissez le nom d’une balise pour créer une balise ou choisissez une balise existante dans le menu déroulant.
...
1. Sur le [!UICONTROL **Exportations**] sélectionnez une ou plusieurs exportations à supprimer.
