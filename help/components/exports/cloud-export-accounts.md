...
1. Après avoir sélectionné **[!UICONTROL Zone d’atterrissage des données]** dans le champ **[!UICONTROL Type de compte]**, sélectionnez [!UICONTROL **Enregistrer**].
