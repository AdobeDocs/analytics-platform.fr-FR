...
Pour une description détaillée des composants de l’interface utilisateur, voir  [Création de mesures](/help/components/calc-metrics/cm-workflow/cm-build-metrics.md).
...
1. Vous accédez à présent automatiquement au [Gestionnaire de mesures calculées](/help/components/calc-metrics/cm-workflow/cm-manager.md), qui est similaire au Gestionnaire de filtres. Il permet de partager, approuver, (re)-baliser, renommer ou supprimer des mesures.
