...
| **[!UICONTROL Titre et description]** | Pour modifier la mesure calculée, sélectionnez le lien de titre qui ouvre le [créateur de mesures calculées](cm-build-metrics.md). Une mesure calculée partagée est indiquée avec ![Partager](/help/assets/icons/ShareLight.svg). |
