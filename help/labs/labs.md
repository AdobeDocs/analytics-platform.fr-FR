...
1. Dans CJA, cliquez sur l’onglet **[!UICONTROL Labs]**.
...
* Générateur d’insights en langage naturel : fournit un résumé en langage naturel de toutes les données que vous analysez dans un tableau à structure libre.
