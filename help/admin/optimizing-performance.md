...
# Optimiser le Customer Journey Analytics et [!UICONTROL Analysis Workspace] performance

Divers facteurs peuvent avoir une influence sur les performances globales des Customer Journey Analytics ainsi que sur les performances d’un projet dans Analysis Workspace. Dans Workspace, un message d’erreur indiquant
...
![Performances d’Analysis Workspace indiquant le facteur réseau, le projet actuel et les instructions.](assets/performance-modal.png)
