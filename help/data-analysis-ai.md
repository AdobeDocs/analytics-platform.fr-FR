...
**Réponse :** l’agent Data Insights de l’assistant d’IA collecte des informations en examinant les données de la vue de données, y compris les mesures et les composants. Cela traduit l’invite en dimensions et mesures appropriées dans la plage de données.
...
**Réponse :** l’agent Data Insights de l’assistant d’IA comprend intelligemment que par « région », vous voulez dire « région du client ». Il génère un graphique à barres qui présente le mieux les recettes par région :
...
**Réponse :** nouveau, l’agent Data Insights de l’assistant d’IA sélectionne la visualisation la plus appropriée, dans ce cas la visualisation **[!UICONTROL en anneau]**, pour répondre à la question.
...
Consultez le tableau suivant d’exemples de termes et d’expressions que vous pouvez utiliser dans les invites avec l’agent Data Insights dans l’assistant AI, ainsi que les types de réponses attendus.

Ces exemples sont conçus pour vous aider à vous familiariser avec la manière dont des mots ou des structures spécifiques peuvent influencer la sortie de l’assistant d’IA, afin de garantir des informations plus précises et plus précieuses. L’agent Data Insights de l’assistant d’IA utilise l’IA générative, de sorte que les visualisations ou les données sélectionnées peuvent légèrement varier dans des invites similaires.
...
Tenez compte des points suivants lors de l’évaluation d’une réponse de l’agent Data Insights de l’assistant d’IA :
