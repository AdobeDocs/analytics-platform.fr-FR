...
5. Sélectionnez l’icône de conversation de l’assistant AI dans la zone supérieure droite de la page.
   ...
   * **[!UICONTROL Assistant IA : analyse des données]**
   ...
   Pour plus d’informations, les administrateurs peuvent consulter [ces instructions](https://experienceleague.adobe.com/en/docs/analytics-platform/using/ai-assistant#feature-access).
