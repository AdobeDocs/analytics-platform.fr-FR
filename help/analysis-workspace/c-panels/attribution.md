...
*Cet article présente le panneau Attribution dans **Customer Journey Analytics**.<br/>Voir [Panneau d’attribution](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/panels/attribution) pour la version **Adobe Analytics**de cet article.*
