...
1. Dans la boîte de dialogue [!UICONTROL **Nouvel export de tableau complet**], spécifiez les informations suivantes :
   ...
   | Tableau des données | Affiche le tableau à structure libre que vous exportez. Vous pouvez modifier le tableau de données en faisant glisser des composants du panneau de gauche vers le tableau. Le tableau se met à jour dynamiquement lorsque vous ajoutez des composants à la zone de travail.  <p>Tous les segments qui ont été appliqués au tableau complet du projet s’affichent en haut de chaque colonne individuelle du tableau.</p> |
