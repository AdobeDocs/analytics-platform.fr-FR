...
>[!NOTE]
>
>Lorsque vous [configurez la légende pour qu’elle soit visible](/help/analysis-workspace/visualizations/freeform-analysis-visualizations.md#settings) dans la dispersion, elle n’est affichée que lorsque la source de données contient un nombre limité d’éléments de dimension (sélectionnés).
