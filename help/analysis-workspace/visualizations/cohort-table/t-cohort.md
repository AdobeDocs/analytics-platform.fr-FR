...
1. Dans le [Créateur de filtres](https://docs.adobe.com/content/help/fr-FR/analytics/components/segmentation/segmentation-workflow/seg-build.html), modifiez davantage le segment, puis cliquez sur **[!UICONTROL Enregistrer]**.
