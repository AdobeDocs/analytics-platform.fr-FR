...
1. Dans Analysis Workspace, cliquez sur l’icône **[!UICONTROL Visualisations]** du rail de gauche et faites glisser un **[!UICONTROL tableau de cohortes]** sur la zone de travail.
   ...
   ![Exemple de tableau de cohortes montrant les critères d’inclusion et de retour.](assets/cohort-table.png)
...
1. Cliquez sur **[!UICONTROL Créer]**.
   ...
   ![ Affichage du tableau de cohortes présentant les critères d’inclusion et de retour sélectionnés. Cliquez sur Créer.](assets/cohort-report.png)

   Le rapport présente les personnes qui ont passé une commande ( *`Included`* colonne) et qui sont retournées sur votre site au cours de visites consécutives. Une réduction des visites au fil du temps permet d’identifier les problèmes et d’agir.
...
Comme les autres visualisations dans Analysis Workspace, vous pouvez télécharger une visualisation de cohortes sous la forme d’un fichier CSV ou de PDF. Pour plus d’informations, voir [Téléchargement des données de projet](/help/analysis-workspace/export/download-send.md).