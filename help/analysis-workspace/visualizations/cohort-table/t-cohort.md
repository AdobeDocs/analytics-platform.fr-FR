...
1. Dans le [Créateur de filtres](/help/components/filters/filter-builder.md), modifiez davantage le segment, puis cliquez sur **[!UICONTROL Enregistrer]**.

   Le segment enregistré peut être utilisé dans le panneau [!UICONTROL Filtre] dans [!UICONTROL Analysis Workspace].
