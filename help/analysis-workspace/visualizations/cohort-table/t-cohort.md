...
Comme les autres visualisations dans Analysis Workspace, vous pouvez télécharger une visualisation de cohortes sous la forme d’un fichier CSV ou de PDF. Pour plus d’informations, voir [Téléchargement de fichiers PDF ou CSV](/help/analysis-workspace/curate-share/download-send.md).