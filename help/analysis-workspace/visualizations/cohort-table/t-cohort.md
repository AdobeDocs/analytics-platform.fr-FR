...
1. (Facultatif) Créez un filtre d’après une sélection.
...
1. Dans le [Créateur de filtres](/help/components/filters/manage-filters.md), modifiez davantage le filtre, puis cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   Le filtre enregistré peut être utilisé dans le panneau [!UICONTROL Filtre] dans [!UICONTROL Analysis Workspace].
