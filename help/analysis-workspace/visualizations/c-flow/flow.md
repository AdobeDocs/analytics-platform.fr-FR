...
*Cet article présente la visualisation Flux dans le Customer Journey Analytics ****. Voir [Flux](https://experienceleague.adobe.com/en/docs/analytics/analyze/analysis-workspace/visualizations/flow/flow) pour la version **Adobe Analytics**de cet article.*
