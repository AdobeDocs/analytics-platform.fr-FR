...
Lorsque vous triez des données sur plusieurs colonnes, les données sont triées en fonction de la priorité que vous attribuez à chaque colonne. La numérotation de priorité s’affiche en regard de l’icône de tri ![SortOrderDown](/help/assets/icons/SortOrderDown.svg)<sup>➊</sup>.
