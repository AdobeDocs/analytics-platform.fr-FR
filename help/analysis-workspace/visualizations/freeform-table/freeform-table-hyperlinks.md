---
title: Création de liens hypertexte dans un tableau à structure libre
...
# Création de liens hypertexte dans un tableau à structure libre
...
Voir ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Créer des liens hypertexte dans un tableau à structure libre](https://video.tv.adobe.com/v/3430411/?quality=12&learn=on){target="_blank"} pour une vidéo de démonstration.
...
* Les liens hypertexte ne sont pas fonctionnels dans les [fichiers de PDF téléchargés](/help/analysis-workspace/export/download-send.md).
