...
| Afficher les prévisions | Détermine si les valeurs de prévision sont affichées dans cette colonne. |
...
<img src="./assets/conditional-formatting.png" alt="Options de mise en forme conditionnelle avec l’option Personnalisé sélectionnée" width="50%" />
