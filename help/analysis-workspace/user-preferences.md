...
1. Dans Customer Journey Analytics, accédez à la variable [!UICONTROL **Projet**] landing page, puis sélectionnez [!UICONTROL **Préférences**].
...
Certaines de ces préférences peuvent également être personnalisées pour des projets individuels, comme décrit dans la section [Présentation du projet](/help/analysis-workspace/build-workspace-project/freeform-overview.md).
...
|  | Afficher les annotations | Indiquez si les annotations sont visibles dans vos projets. Pour plus d’informations sur les annotations, voir [Présentation des annotations](/help/components/annotations/overview.md). |
...
|  | Ventilation par position | Sélectionnez cette option si vous souhaitez que la ventilation reste avec la position de l’élément plutôt qu’avec l’élément lui-même. Pour plus d’informations sur les ventilations, voir [Ventilation des dimensions](/help/components/dimensions/t-breakdown-fa.md). |
...
| **Graphiques empilés** |  |  |
|  | 100 % empilé | Ce paramètre appliqué aux graphiques à zones empilées, à barres empilées ou à barres horizontales empilées offre un aperçu « 100 % empilé » du diagramme. <p>Pour plus d’informations, voir [Barre et barres empilées](/help/analysis-workspace/visualizations/bar.md).</p> |
...
| **[Numéro du résumé](/help/analysis-workspace/visualizations/summary-number-change.md)** |  |  |
...
| **[Nuage de points](/help/analysis-workspace/visualizations/scatterplot.md)** |  |  |
