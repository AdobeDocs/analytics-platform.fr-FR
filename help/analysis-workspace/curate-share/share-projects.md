...
Si un destinataire n’a pas de rôle et reçoit une [link](https://docs.adobe.com/content/help/en/analytics/analyze/analysis-workspace/curate-share/shareable-links.html) au projet (**[!UICONTROL Partager]>[!UICONTROL Obtenir le lien du projet]**), ils seront placés par défaut dans un rôle. Les administrateurs reçoivent **[!UICONTROL Peut modifier]** et les non-administrateurs reçoivent **[!UICONTROL Peut dupliquer]**.
