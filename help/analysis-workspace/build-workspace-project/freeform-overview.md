...
| Élément | Description |
|---|---|
| [Créer un projet](/help/analysis-workspace/home.md) | Cliquez sur ce lien pour début d&#39;un nouveau projet à partir de zéro ou d&#39;un [modèle](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/build-workspace-project/starter-projects.html?lang=en#analysis-workspace) créé pour vous. |
...
| Copier | Créez une copie de duplicata de votre projet. Cela crée un nouveau projet et un nouvel ID de projet. Les partages ou les planifications liés au projet initial ne seront pas copiés. |
