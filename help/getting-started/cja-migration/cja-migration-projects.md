---
title: Migration de projets et de composants vers Customer Journey Analytics
description: Découvrez la migration des composants pour la migration des projets et composants vers Customer Journey Analytics.
role: Admin
...
# Étape 9 : migration des projets et des composants vers Customer Journey Analytics
...
Les informations de cette page portent sur l’étape 9, comme indiqué dans le tableau ci-dessous :
...
| <span class="preview">**Étape 9 : [Migration de projets et de composants](/help/getting-started/cja-migration/cja-migration-projects.md)**</span> | <span class="preview">La zone de migration Composant d’Adobe Analytics vous permet de migrer les projets et leurs composants associés d’Adobe Analytics vers Customer Journey Analytics.</span> |
...
La zone de migration Composant d’Adobe Analytics vous permet de migrer les projets et leurs composants associés d’Adobe Analytics vers Customer Journey Analytics.
...
## Ensuite, effectuez les tâches post-migration

Après vous [Migration des composants et des projets d’Adobe Analytics vers Customer Journey Analytics](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/component-migration/component-migration.html?lang=fr), vous devez effectuer diverses tâches pour terminer la configuration de votre environnement de Customer Journey Analytics. Ces tâches consistent à importer d’autres données dans Experience Platform, à créer des connexions entre les jeux de données Platform et Customer Journey Analytics, à créer des vues de données et à apprendre à créer des rapports sur les données cross-canal dans Analysis Workspace.

En savoir plus sur ces tâches de migration dans [Prise en main du Customer Journey Analytics](/help/getting-started/cja-getting-started.md).
