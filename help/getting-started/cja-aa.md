...
| [!UICONTROL Appareil], [!UICONTROL Navigateur], [!UICONTROL Référent], [!UICONTROL Technologie] dimensions | Ces dimensions sont automatiquement incluses lorsqu’un jeu de données AEP inclut des champs de schéma XDM spécifiques et est conforme à la classe XDM Experience Event. Reportez-vous à notre [Documentation sur laquelle les variables Analytics sont prises en charge via Analytics Source Connector.](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/mapping/analytics.html?lang=en). Pour les clients CJA qui n’utilisent pas le connecteur source pour renseigner les données d’Adobe Analytics dans CJA, mais qui utilisent plutôt la collecte de données du SDK Web AEP, [!UICONTROL Appareil] Les dimensions et basées sur la recherche de périphérique ne sont actuellement pas prises en charge, mais le seront prochainement. |
...
| Dimensions Géosegmentation | Toute la géosegmentation/géographie collectée dans Adobe Analytics est transmise à CJA par le biais de la variable [Connecteur source Analytics](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=en). Les mises en oeuvre qui n’utilisent pas le connecteur source Analytics, telles que celles qui reposent sur le SDK Web AEP pour la collecte de données numériques, ne disposent pas de la totalité de la plage de recherches géographiques exécutées automatiquement : Le pays et l’état des États-Unis sont pris en charge, la ville et le fichier ZIP ne le sont pas. Actuellement, les États/régions situés en dehors des États-Unis ne bénéficient que d’une prise en charge limitée ou inexistante. |
