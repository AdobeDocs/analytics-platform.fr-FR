...
1. **Implémenter le SDK web Experience Platform (pour la collecte de données en cours)**
   ...
   * Consolidez la mise en œuvre de la collecte de données d’entreprise Adobe CX entre d’autres produits d’entreprise CX (AJO, RTCDP, etc.).
