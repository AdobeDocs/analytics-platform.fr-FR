...
Si vous venez de Google Analytics 4 en particulier, consultez la section [Transition de Google Analytics 4 vers Customer Journey Analytics](../ga-to-cja/home.md) pour obtenir des conseils axés sur les analystes sur les équivalents de rapports, les différences de modèle de données et les comparaisons de mesures.
