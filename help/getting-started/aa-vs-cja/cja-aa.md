...
| --- | --- |
| A4T | La prise en charge est assurée par l’intermédiaire des champs du [Connecteur source  Analytics](https://experienceleague.adobe.com/docs/experience-platform/sources/connectors/adobe-applications/analytics.html?lang=fr). |
...
| Création de rapports sur les nouvelles sessions et les sessions répétées | Pris en charge [avec un intervalle de recherche en amont de 13 mois](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-dataviews/data-views-usecases.html?lang=fr#new-repeat). |
