...
description: Découvrez une comparaison des fonctionnalités de Customer Journey Analytics à l’ensemble des fonctionnalités d’Adobe Analytics.
...
| Fonctionnalité Adobe Analytics | Notes sur la prise en charge de Customer Journey Analytics |
| --- | --- |
| **Détection des anomalies** | Prise en charge complète |
| **Transfert de ressources** | Prise en charge complète |
| **Fonctionnalités d’attribution** | Prise en charge complète |
| **Détection de robots** | [Prise en charge complète](https://experienceleague.adobe.com/fr/docs/experience-platform/datastreams/bot-detection) |
...
| Fonctionnalité | Notes |
| --- | --- |
| **Activity Map** | La prise en charge n’est pas encore prévue. |
| **Analyse des contributions** | La prise en charge n’est pas encore prévue. |
