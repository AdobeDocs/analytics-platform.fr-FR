...
| **Alertes** | Le processus d’utilisation de [alertes](/help/components/c-intelligent-alerts/intelligent-alerts.md) en Customer Journey Analytics est presque identique à celui d’Adobe Analytics. Cependant, il existe [des différences importantes](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/alerts/alerts-feature-comparison). |
