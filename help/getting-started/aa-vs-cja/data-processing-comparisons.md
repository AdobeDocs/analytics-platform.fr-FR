...
En outre, ni les visites ni les sessions en tant que mesure ne sont disponibles dans les jeux de données créés par le connecteur source Analytics et vous obligeraient donc à définir la session dans votre logique de requête pour effectuer des comparaisons.
