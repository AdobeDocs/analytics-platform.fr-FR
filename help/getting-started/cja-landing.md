...
Découvrez les améliorations les plus récentes apportées au produit et à la documentation de Customer Journey Analytics. Pour obtenir une liste complète des fonctionnalités, améliorations et correctifs, consultez les [notes de mise à jour](../release-notes/latest.md) détaillées. Accédez à la [page des mises à jour de la documentation](../release-notes/doc-changes.md) pour connaître les dernières modifications.
...
*_Vous devez disposer du package Ultimate pour les rapports en temps réel._*
