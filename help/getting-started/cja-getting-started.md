...
| Tâche | Détails |
| --- | --- |
| **Étape 1 : si vous effectuez une mise à niveau d’Adobe Analytics vers Customer Journey Analytics : choisissez un chemin de mise à niveau et envoyez des données vers Adobe Experience Platform** | Plusieurs chemins sont disponibles lors de la mise à niveau d’Adobe Analytics vers Customer Journey Analytics. Chaque chemin de mise à niveau possible présente ses propres avantages et inconvénients, et un chemin approprié pour une organisation peut ne pas avoir de sens pour une autre. <p>Pour commencer la mise à niveau d’Adobe Analytics vers Customer Journey Analytics, voir [Prise en main de la mise à niveau vers Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md). <!-- [Utilizing Adobe Analytics report suite data in Customer Journey Analytics](/help/getting-started/aa-vs-cja/aa-data-in-cja.md) --> </p> |
