...
| Tâche | Détails |
| --- | --- |
| **Étape 1 : Si vous effectuez une migration d’Adobe Analytics vers CJA, lisez le guide d’administration.** | [Adobe Analytics vers l’évolution des Customer Journey Analytics](/help/getting-started/aa-to-cja.md) |
