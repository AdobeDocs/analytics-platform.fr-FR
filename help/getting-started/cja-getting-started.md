...
| Tâche | Où effectué | Informations |
|---|---|---|
...
| **Étape 4 : Création de connexions entre les jeux de données de plateformes et les analyses de parcours du client** | Analytics du parcours client | See [Create a connection](/help/connections/create-connection.md). |
