...
| Tâche | Détails |
| --- | --- |
| **Étape 1 : si vous effectuez une mise à niveau d’Adobe Analytics vers Customer Journey Analytics : choisissez un chemin de mise à niveau et envoyez des données à Adobe Experience Platform** | Plusieurs chemins sont disponibles lors de la mise à niveau d’Adobe Analytics vers Customer Journey Analytics. Chaque chemin de mise à niveau possible a ses propres avantages et inconvénients. Ainsi, un chemin approprié pour une organisation peut ne pas avoir de sens pour une autre. <p>Pour commencer la mise à niveau d’Adobe Analytics vers Customer Journey Analytics, effectuez l’une des opérations suivantes :</p><ul><li>Suivez le chemin de mise à niveau recommandé par Adobe. Pour plus d’informations, voir [Chemin recommandé lors de la mise à niveau d’Adobe Analytics vers Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md).</li><li>Découvrez tous les chemins de mise à niveau disponibles et choisissez le chemin qui convient le mieux à votre entreprise. Pour plus d’informations, voir [Prise en main de la mise à niveau vers Customer Journey Analytics](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md).</li></ul> |
