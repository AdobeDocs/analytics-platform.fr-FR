...
La page de destination de Customer Journey Analytics comprend une page d’accueil destinée à la gestion des projets, ainsi qu’une section d’apprentissage pour vous aiguiller.

>[!VIDEO](https://video.tv.adobe.com/v/334278/?quality=12)

## Accès à la page de destination {#access-landing}

Après vous être connecté à Adobe Experience Cloud et Customer Journey Analytics, activez le bouton bascule [!UICONTROL Nouvelle page de destination - Beta] dans le coin inférieur gauche. Lʼaccès au bouton bascule est spécifique à chaque utilisateur par organisation, et non à la société.

![Page de destination](assets/landing.png)

Vous pouvez :

* développer le tableau [!UICONTROL Projets] pour l’afficher en plein écran. Pour agrandir le tableau, il suffit de cliquer sur l’icône du menu hamburger. Cela réduira les onglets du rail de gauche ;
* adapter la largeur des colonnes en faisant glisser le séparateur de colonnes ;
* réorganiser les éléments épinglés. Pour déplacer les éléments épinglés vers le haut et le bas, cliquez sur les points de suspension en regard de l’élément épinglé et sélectionnez **[!UICONTROL Déplacer vers le haut]** ou **[!UICONTROL Déplacer vers le bas]**.
...
| [!UICONTROL Partagé avec] | Personne(s) avec qui ce projet a été partagé. |
...
| [!UICONTROL Planifié] | Choisissez [!UICONTROL Activé] si un projet est planifié, ou **[!UICONTROL Désactivé]** dans le cas contraire. Le fait de cliquer sur le lien **[!UICONTROL Activé]** vous renvoie aux informations du projet planifié. Vous pouvez également [modifier le calendrier du projet](/help/analysis-workspace/curate-share/t-schedule-report.md) si vous en êtes le propriétaire. |
| [!UICONTROL Identifiant du projet] | L’identifiant peut être utilisé pour procéder au débogage des projets. |
...
| Icône de personnalisation du tableau | (En haut à droite) Si vous souhaitez ajouter ou supprimer des colonnes de la liste des projets, sélectionnez-les ou désélectionnez-les. |
| &lt; (bouton Précédent) | Ce bouton, présent dans les projets Workspace, vous ramène à la dernière configuration de votre page de destination. La configuration de page que vous aviez lorsque vous avez quitté la page de destination persiste à votre retour. |
