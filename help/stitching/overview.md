...
- [Demander à activer le rapprochement](/help/stitching/use-stitching.md)
- [Activer le rapprochement dans l’interface Connexions](/help/stitching/use-stitching-ui.md) [!BADGE Beta]{type=Informative}
