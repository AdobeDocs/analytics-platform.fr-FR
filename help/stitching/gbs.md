...
![Service d’identités](assets/uis-gbs.png){zoomable="yes"}
...
Avec un groupement de relecture se produisant au 13/05/2023 à 16 h 30, avec une configuration d’intervalle de recherche en amont de 24 heures, certains événements de l’exemple sont regroupés à nouveau (indiqué par ![Relecture](/help/assets/icons/Replay.svg)).
