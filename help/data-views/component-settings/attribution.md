...
| ![Même touche](../assets/attribution-models/same_touch.png) | Même touche | Attribue un crédit de 100 % au même accès que celui où la conversion a eu lieu. Si un point de contact ne se produit pas sur le même accès qu’une conversion, il est placé sous « Aucun ». Ce modèle d’attribution est parfois assimilé à l’absence de modèle d’attribution. Elle s’avère utile dans les cas où vous ne souhaitez pas que des valeurs issues d’autres accès affectent la manière dont une mesure attribue du crédit aux éléments de dimension. Les équipes produit ou de conception peuvent utiliser ce modèle pour évaluer l’efficacité d’une page où une conversion se produit. |
