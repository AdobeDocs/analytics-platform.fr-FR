...
>abstract="Cette fonction permet de renvoyer la différence entre deux champs de date ou d’heure. Les champs basés sur des personnes (à partir de jeux de données de profil) ne disposent pas d’options pour **[!UICONTROL Renvoyer le premier]** et **[!UICONTROL Renvoyer le dernier.]**."
