...
Consultez l’article [Gestion d’aucune valeur](./no-value.md) pour plus d’informations sur la gestion de divers scénarios de cas d’utilisation **[!UICONTROL Aucune valeur]**.
...
Ces nouveaux paramètres vous permettent d’afficher uniquement les revenus à forte valeur et de filtrer tout montant inférieur à 50 $.
...
* Pour un canal marketing donné, ou une campagne spécifique, est-ce que vous ciblez les nouveaux utilisateurs ou les utilisateurs récurrents ? Comment ce choix influence-t-il les taux de conversion ?
...
* Pour le format de date et heure, si vous sélectionnez **[!UICONTROL Minute de la journée]** avec le format **[!UICONTROL Heure:Minute]**, la sortie peut ressembler à : 20:20.
