...
Cet article explique comment réaliser un certain nombre de cas d’utilisation (15) à l’aide de l’extension Customer Journey Analytics BI. Chaque cas d’utilisation décrit la fonctionnalité de Customer Journey Analytics, suivi de détails pour chacun des outils de BI pris en charge :

* **Bureau**. La version utilisée est 2.137.1102.0 64 bits (octobre 2024).
...
* **Connexion**
   * [Connecter et répertorier les vues de données](bi-extension/connect-and-validate.md)

* **Rapport et analyse**
   * [Tendance quotidienne](bi-extension/daily-trend.md)
   * [Tendance horaire](bi-extension/hourly-trend.md)
   * [Tendance mensuelle](bi-extension/monthly-trend.md)
   * [Classement sur une seule dimension](bi-extension/single-dimension-ranked.md)
   * [Classement de plusieurs dimensions](bi-extension/multiple-dimension-ranked.md)
   * [Compter les valeurs de dimension distinctes](bi-extension/count-distinct-dimension-values.md)
   * [Utilisation de noms de périodes pour le filtrage](bi-extension/use-date-range-names-to-filter.md)
   * [Utiliser des noms de segment pour segmenter](bi-extension/use-segment-names-to-segment.md)
   * [Utilisation des valeurs de dimension pour segmenter](bi-extension/use-dimension-values-to-segment.md)
   * [Tri](bi-extension/sort.md)
   * [Limites](bi-extension/limits.md)

* **Comprendre**

   * [Transformations](bi-extension/transformations.md)
   * [Visualisations](bi-extension/visualizations.md)
   * [Avertissements](bi-extension/caveats.md)
...
Power BI Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/fr/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Credentials guide](https://experienceleague.adobe.com/fr/docs/experience-platform/query/ui/credentials)
* [Connect Power BI to Query Service](https://experienceleague.adobe.com/fr/docs/experience-platform/query/clients/power-bi).
...
Tableau Desktop supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/fr/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
* [Prerequisites](/help/data-views/bi-extension.md#prerequisites)
* [Credentials guide](https://experienceleague.adobe.com/fr/docs/experience-platform/query/ui/credentials)
* [Connect Tableau Desktop to Query Service](https://experienceleague.adobe.com/fr/docs/experience-platform/query/clients/tableau).
...
Looker supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/fr/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
Jupyter Notebook supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/fr/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
...
RStudio supports the following scenarios for the `FLATTEN` parameter. See [Flatten nested data](https://experienceleague.adobe.com/fr/docs/experience-platform/query/key-concepts/flatten-nested-data) for more information.
