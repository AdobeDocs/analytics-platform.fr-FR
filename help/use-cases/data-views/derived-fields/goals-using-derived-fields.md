...
Si vous ne connaissez pas les champs dérivés, reportez-vous aux sections [tutoriel](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/data-views/derived-fields-in-cja.html?lang=fr) et [documentation](/help/data-views/derived-fields/derived-fields.md) pour une introduction.
