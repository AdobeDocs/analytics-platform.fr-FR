...
Voir ![VideoCheckedOut](/help/assets/icons/VideoCheckedOut.svg) [Import de données Google Analytics dans Adobe Experience Platform](https://video.tv.adobe.com/v/3437168?captions=fre_fr&quality=12&learn=on){target="_blank"} pour une vidéo de démonstration.
