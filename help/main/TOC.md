...
+ Mettre à niveau et comparer {#compare-aa-cja}
   + Mettre à niveau vers Customer Journey Analytics {#upgrade-to-cja}
      ...
      + [Préparation de votre organisation](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md)
...
+ Projets Workspace {#cja-workspace}
   ...
   + Traiter et partager {#curate-share}
      ...
      + [Générer des présentations de diapositives](/help/analysis-workspace/curate-share/generate-slides.md)
   + Exporter {#export}
