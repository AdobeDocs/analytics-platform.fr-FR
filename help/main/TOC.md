...
+ Mettre à niveau et comparer {#compare-aa-cja}
   + Mettre à niveau vers Customer Journey Analytics {#upgrade-to-cja}
      + {hide-from-toc}[Prise en main](/help/getting-started/cja-upgrade/cja-upgrade-getstarted.md)
      + {hide-from-toc}[Choisissez le chemin de mise à niveau](/help/getting-started/cja-upgrade/cja-upgrade-path.md)
      + {hide-from-toc}[Envoyer des données à Platform](/help/getting-started/cja-upgrade/cja-upgrade-send-to-platform.md)
      + {hide-from-toc}[Conserver les données historiques](/help/getting-started/cja-upgrade/cja-upgrade-historical-data.md)
      + [Processus de mise à niveau recommandé](/help/getting-started/cja-upgrade/cja-upgrade-recommendations.md)
      + [Préparer votre organisation](/help/getting-started/cja-upgrade/cja-upgrade-org-readiness.md)
...
+ Miroir de données {#cja-data-mirror}
   ...
   + [Guide de démarrage rapide de Data Mirror](/help/data-mirror/relational.md)
...
+ Connexions {#cja-connections}
   ...
   + Analyse de l’audience {#audience-analysis}
      + [Vue d’ensemble](/help/connections/audience-analysis/audience-analysis-overview.md)
      + [Configurer](/help/connections/audience-analysis/audience-analysis-configure.md)
...
+ Vues des données {#cja-dataviews}
   ...
   + {hide-from-toc}[Bonnes pratiques](/help/data-views/derived-fields/best-practices.md)
...
+ Projets Workspace {#cja-workspace}
   ...
   + Visualisations {#visualizations}
      ...
      + Tableau à structure libre {#freeform-table}
         ...
         + [Inclure plusieurs dimensions](/help/analysis-workspace/visualizations/freeform-table/freeform-table-multidimensions.md)
   ...
   + Traiter et partager {#curate-share}
      ...
      + [Générer des présentations en diapositives](/help/analysis-workspace/curate-share/generate-slides.md)
   + Exporter {#export}
...
+ Composants {#cja-components}
   ...
   + Exports {#exports}
      ...
      + Flux de données {#cja-data-feeds}
         + {hide-from-toc}[Aperçu des flux de données](/help/components/exports/cja-data-feeds/data-feed-overview.md)
...
+ Résolution des problèmes {#troubleshooting}
   + [Comparer les données du connecteur source](../troubleshooting/compare.md)
...
+ Notes techniques {#technotes}
   ...
   + [ID incorrects](/help/technotes/badids.md)
   + [Navigateur et langue](/help/technotes/browser-language.md)
