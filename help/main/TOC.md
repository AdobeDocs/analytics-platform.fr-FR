...
+ Vues des données {#cja-dataviews}
  ...
  + Paramètres de composant {#component-settings}
    ...
    + {hide-from-toc}[Portée](/help/data-views/component-settings/scope.md)
...
+ Informations sur la conversation {#conversation-insights}
  + {hide-from-toc}[Vue d’ensemble](/help/conversatiion-insights/conversation-insights.md)
...
+ Rapports sur la population totale {#tpr}
  ...
  + {hide-from-toc}[Recherches partagées](/help/tpr/shared-lookups.md)
